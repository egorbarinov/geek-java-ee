...
public class CategoryServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (req.getPathInfo() == null || req.getPathInfo().equals("/")) {
            ...
            getServletContext().getRequestDispatcher("/WEB-INF/category/category.jsp").forward(req, resp);
            ...
            getServletContext().getRequestDispatcher("/WEB-INF/category/category_form.jsp").forward(req, resp);
            ...
            getServletContext().getRequestDispatcher("/WEB-INF/category/add_category.jsp").forward(req, resp);
        }
    }
